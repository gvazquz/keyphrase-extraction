Run the *.py files in the next order:
	...
	1. preprocessing.py -> Preprocesses the text of the documents to find the noun phrases aka. candidate key phrases.
	...
	12. analysis_keyphrases.py -> TF analysis of the expert assigned key phrases aka. gold standards.