...
# This code creates a directed graph with the next characteristics:
...
for f_num in range (1,2305):
    ...
    save_pairs(counts,"graphs/directed/%d.txt" % f_num)
    print "Directed graph No. %d is finished" % f_num
